...
def updateReadySJF(ready, processes, time): # function to update ready[]. if any new process came, it'll be added to it and again it will be sorted on the basis of arrival time.
...
def SJFNonPreEmptive(processes):# main function which will implement FCFS scheduling process.
	...
	ready=[]
	ready=updateReadySJF(ready, processes, time)
