...
def updateOutput(outputQueue, processes, outputRunning, time, endedProcess, inputQueue, currentShare, totalTickets, number): # to update outputQueue[] i.e. to check if any process has done it's work on output devices or if not than decrease it's time by 1.
