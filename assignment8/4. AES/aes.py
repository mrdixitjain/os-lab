...
if __name__ == "__main__":
    moo = AESModeOfOperation()
    cleartext = "This is a test with several blocks! how are you awjfkjio foijioejkjf nsoifuoijfkm fjwfiow09irn rwajuhwia fjaoijfpw fjnfoawijf ffojfoi fpa[weojiej"
